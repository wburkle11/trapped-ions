...
plt.imshow(normalize_for_display(rl_clean, DISPLAY_GAMMA), cmap="inferno", interpolation="none")
...
if MAKE_FINAL_ZOOM_PLOT:
    ...
    plt.imshow(normalize_for_display(rl_zoom, DISPLAY_GAMMA), cmap="inferno", interpolation="none")
