...
def max_qfactor4(C_t, R_t, B, D, d, d_0):
...
#R_t = 3 
#omega_0 = 14164762.44
#B = np.linspace(0.080, 0.400, 200)

#computed_qs = max_qfactor4(C_t, R_t, B)
#print(computed_qs)
#print(b)
#print(B)

#plt.plot(B, computed_qs)

#index_max = np.argmax(computed_qs)
#best_B = B[index_max]
